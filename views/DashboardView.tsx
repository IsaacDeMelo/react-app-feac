    ...
    if (file) {
      ...
      setFormData(prev => ({
        ...
        attachment: {
          name: file.name,
          type: file.type,
          data: '' // Will be generated by Firebase on submit
        }
      }));
    }
  };
      ...
      if (editingId) {
        ...
        if (original) {
          ...
          await updateActivity({
            ...
            attachment: formData.attachment || undefined // This carries the old URL if no new file
          }, fileToPass);
        }
      } else {
        // Create new
                             ...
                             <>
                               ...
                               <div className="flex-1">
                                 ...
                                 <p className="text-xs text-brand-500 mt-0.5">
                                   {selectedFile ? 'Arquivo para enviar' : 'Anexo existente'}
                                 </p>
                               </div>
